...
(defconst my/emacs-health-checks
  '((required "rg" "Ripgrep for project search")
    ...
    (optional "ty" "Python LSP")
    (optional "ruff" "Python linting and formatting")
    ...
    (optional "prettier" "Web/JSON/YAML/Markdown formatting")
    (optional "sql-formatter" "SQL formatting")
